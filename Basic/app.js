...
const SUBJECT_TIMERS = {
  Mathematics: 25 * 60,
  "Civic Education": 10 * 60,
  "Basic Science": 10 * 60,
  "Computer Studies": 10 * 60,
  "English": 10 * 60,
  "English Language": 10 * 60 // support alternative label
};
const MAIN_SUBJECT_NAMES = ["Mathematics","Civic Education","Basic Science","Computer Studies","English","English Language"];
const DEFAULT_TIMEMIN = 7 * 60;
const SUBJECT_DISPLAY_COUNT = (subject) => {
  if (MAIN_SUBJECT_NAMES.includes(subject)) return 25;
  return 20;
};
